# Dark Landing Page Task Flow

Dark Theme SaaS Landing Page template built with **Next.js**, **Framer Motion** and **Tailwind CSS**. Perfect for launching your product or service website with a sleek, professional design.

---

## Attribution Disclaimer

**Design adapted from** [SaaS Website UI Kit — Framer Website Kit](https://www.figma.com/community/file/1347551304372055519) by Framer (licensed under CC BY 4.0).
...
1. **Clone the repository**
   ...
   ```bash
   git clone https://github.com/AymaneMehdi/Dark-Landing-Page-Task-Flow.git
   cd Dark-Landing-Page-Task-Flow
   ```
...
|--------------------------|-------------------------------------------|
| **Next.js 14.2.4**       | React framework for production apps      |
